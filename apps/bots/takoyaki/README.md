...
A Discord bot for managing ISFL/DSFL league operations, including TPE tracking, index updates, CTF scoring, fantasy drafts, and community stats.
...
- **CTF Commands** - Capture-the-flag scoring commands (authorized users only)
...
| `CTF_AUTHORIZED_USER_ID` | Discord user ID authorized to run CTF commands |
...
└── lib/
    ...
    ├── ctf.ts    # CTF authorization helper
