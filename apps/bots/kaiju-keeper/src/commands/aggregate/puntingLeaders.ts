...
export default {
  command: new SlashCommandBuilder()
    ...
    .setDescription('Get Stat Leaders (Punting)'),
  execute: async (interaction) => {
    try {
      ...
      const gameRecords = await UnifiedDatabaseClient.getPuntingStats(teamAbbr, undefined, undefined, activeOnly);
