...
export default {
  command: new SlashCommandBuilder()
    ...
    .setDescription('Get Stat Leaders (Receiving)'),
  execute: async (interaction) => {
    try {
      ...
      const gameRecords = await UnifiedDatabaseClient.getReceivingStats(teamAbbr, undefined, undefined, activeOnly);
